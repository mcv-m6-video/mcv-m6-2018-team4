...
def objectTrackerCV2(images, masks, distThreshold, verbose=False):
    ...
    for lbl in range(1,nlbl+1):
        ...
        bbox_cv2 = (object.bbox[2],object.bbox[0],object.bbox[1]-object.bbox[0], object.bbox[3]-object.bbox[2])
    ...
    for i in range(1,len(images)):
        ...
        for abc in range(len(trackers)):
            ...
            oklist.append(ok)
            our_bbox = np.array([bbox[1],bbox[2]+bbox[1],bbox[0],bbox[3]+bbox[0]],dtype=np.int)
